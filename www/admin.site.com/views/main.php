...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="#">一站管家-PC后台</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="#">一站管家-H5手机后台</a>
				...
				<ul class="cl">
					<li class="dropDown dropDown_hover"><a href="javascript:;" class="dropDown_A"><i class="Hui-iconfont">&#xe671;</i>站内快链<i class="Hui-iconfont">&#xe6d5;</i></a>
						<ul class="dropDown-menu menu radius box-shadow">
							<li><a href="javascript:;" onclick="member_add('部门管理','/department/department_list/','1000')"><i class="Hui-iconfont">&#xe616;</i> 部门管理</a></li>
                            <li><a href="javascript:;" onclick="member_add('职务管理','/job/job_list/','1000')"><i class="Hui-iconfont">&#xe616;</i> 职务管理</a></li>
					</ul>
				</li>
			</ul>
		</nav>
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-picture">
			...
			<dd>
				<ul>
					<li><a data-href="/task/task_doing_list/20" data-title="任务进行中" href="javascript:void(0)">任务进行中</a></li>
					<li><a data-href="/task/task_doing_list/100" data-title="任务已完成" href="javascript:void(0)">任务已完成</a></li>
					<li><a data-href="/task/task_doing_list/30" data-title="任务进行中已超时" href="javascript:void(0)">任务进行中已超时</a></li>
                    <li><a data-href="/task/task_doing_list/10" data-title="建立未开始" href="javascript:void(0)">建立未开始</a></li>
                    <li><a data-href="/task/task_doing_list/-100" data-title="已关闭的任务" href="javascript:void(0)">已关闭的任务</a></li>

					<li><a data-href="/task/task_doing_list/40" data-title="超时程度设置" href="javascript:void(0)">超时程度设置</a></li>
			</ul>
		</dd>
	</dl>
		...
		<dl id="menu-member">
			...
			<dd>
				<ul>
					<li><a data-href="/admin/admin_edit_passwd" data-title="密码修改" href="javascript:;">密码修改</a></li>
...
<section class="Hui-article-box">
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active">
					<span title="进行中任务" data-href="/task/task_doing_list/">进行中任务</span>
					<em></em></li>
		</ul>
	</div>
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="/task/task_doing_list/"></iframe>
	</div>
</div>
</section>
