...
<form action="" class="layui-form layui-form-pane1" id="form1">
    ...
    <div class="layui-form-item" style="width:800px;">
        ...
        <div class="layui-input-inline" style="width:400px;">
            <input type="text" name="job_name" lay-verify="required|title"  placeholder="职务名字" autocomplete="off" class="layui-input" id="job_name" value="<?=$item['job_name']?>">
        </div>
    ...
    <div class="layui-form-item" style="width:800px;">
        ...
        <div class="layui-input-inline" style="width:400px;">
            <input type="text" name="job_content"  placeholder="备注说明" autocomplete="off" class="layui-input" id="job_content" value="<?=$item['job_content']?>">
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="job_authority" lay-filter="cate_01" lay-search  id="dl1">
                ...
                for($i=0;$i<11;$i++){
                    ?>
                    <option value="<?=$i?>" <?php if($i==$item['job_authority']){echo "selected";};?>>权限值<?=$i?></option>
                    <?php
                }
                ?>
            </select>
