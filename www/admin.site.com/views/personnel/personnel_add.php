...
<form action="" class="layui-form layui-form-pane1" id="form1">
    ...
    <div class="layui-form-item" style="width:800px;">
        ...
        <div class="layui-input-inline" style="width:400px;">
            <input type="text" name="ture_name" lay-verify="required|title"  placeholder="请输入行政人员名字" autocomplete="off" class="layui-input" id="ture_name">
        </div>
    ...
    <div class="layui-form-item" style="width:800px;">
        ...
        <div class="layui-input-inline" style="width:400px;">
            <input type="text" name="phone"  placeholder="请输入手机号码" autocomplete="off" class="layui-input" id="phone">
        </div>
    ...
    <div class="layui-form-item" style="width:800px;">
        ...
        <div class="layui-input-inline" style="width:400px;">
            <input type="text" name="passwd"  placeholder="yz123456" autocomplete="off" class="layui-input" id="passwd" value="yz123456">
        </div>
        <div class="layui-form-mid layui-word-aux">默认: yz123456</div>
    </div>
        ...
        <div class="layui-input-inline">
            <select name="job_id" lay-filter="cate_02" lay-search  id="dl1">
				...
				<?php
				 ...
				 ?>
				  <option value="<?=$val['id']?>"><?=$val['job_name']?></option>
				<?php
				}
				?>
            </select>
    ...
    <div class="layui-form-item" style="width:800px;">
        ...
        <div class="layui-input-inline" style="width:400px;">
            <input type="text" name="try_work_time"  placeholder="请选择时间" autocomplete="off" class="layui-input" id="try_work_time" value="">
        </div>
    ...
    <div class="layui-form-item" style="width:800px;">
        ...
        <div class="layui-input-inline" style="width:400px;">
            <input type="text" name="company_time"  placeholder="请选择时间" autocomplete="off" class="layui-input" id="company_time" value="">
        </div>
    ...
    <div class="layui-form-item" pane>
        ...
        <div class="layui-input-block">
            <input type="checkbox" checked name="is_login" lay-skin="switch" lay-filter="switchTest" lay-text="ON|OFF" id="is_login" value="1">
        </div>
    </div>
...
<script>
    ...
    function save_data_func(){
        ...
        $.ajax({
            ...
            url: "/personnel/personnel_add/save",
