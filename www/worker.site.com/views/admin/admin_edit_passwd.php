...
<form action="" class="layui-form layui-form-pane1" id="form1">
    ...
    <div class="layui-form-item" style="width:800px;">
        ...
        <div class="layui-input-inline" style="width:400px;">
            <input type="text" name="dept_name" lay-verify="required|title"  placeholder="部门名字" autocomplete="off" class="layui-input" id="dept_name" value="">
        </div>
    ...
    <div class="layui-form-item" style="width:800px;">
        ...
        <div class="layui-input-inline" style="width:400px;">
            <input type="text" name="dept_content"  placeholder="新密码" autocomplete="off" class="layui-input" id="dept_content" value="">
        </div>
        <div class="layui-form-mid layui-word-aux">如：6~20位</div>
    </div>

    <div class="layui-form-item" style="width:800px;">
        <label class="layui-form-label">确认密码</label>
        <div class="layui-input-inline" style="width:400px;">
            <input type="text" name="dept_content"  placeholder="确认密码" autocomplete="off" class="layui-input" id="dept_content" value="">
        </div>
        <div class="layui-form-mid layui-word-aux">如：6~20位</div>
    </div>
