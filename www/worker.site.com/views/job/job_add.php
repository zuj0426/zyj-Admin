...
<form action="" class="layui-form layui-form-pane1" id="form1">
    ...
    <div class="layui-form-item" style="width:800px;">
        <label class="layui-form-label">职务名字</label>
        <div class="layui-input-inline" style="width:400px;">
            <input type="text" name="job_name" lay-verify="required|title"  placeholder="请输入职务名字" autocomplete="off" class="layui-input" id="job_name">
        </div>
        <div class="layui-form-mid layui-word-aux">如：主管</div>
    </div>
    ...
    <div class="layui-form-item" style="width:800px;">
        ...
        <div class="layui-input-inline" style="width:400px;">
            <input type="text" name="job_content"  placeholder="请输入备注说明" autocomplete="off" class="layui-input" id="job_content">
        </div>
        <div class="layui-form-mid layui-word-aux">如：测试，app,后端，功能测试</div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="job_authority" lay-filter="cate_01" lay-search  id="dl1">
                <option value=""></option>
                <?php
                for($i=0;$i<11;$i++){
                    ?>
                    <option value="<?=$i?>">权限值<?=$i?></option>
                    <?php
                }
                ?>
            </select>
        </div>
        <div class="layui-form-mid layui-word-aux"><p class="layui-btn layui-btn-small">值越大，权限越高，总陈10指派主管8</p></div>
    </div>
