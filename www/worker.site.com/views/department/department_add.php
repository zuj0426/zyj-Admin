...
<form action="" class="layui-form layui-form-pane1" id="form1">
    ...
    <div class="layui-form-item" style="width:800px;">
        ...
        <div class="layui-input-inline" style="width:400px;">
            <input type="text" name="dept_name"  placeholder="请输入部门名字" autocomplete="off" class="layui-input" id="dept_name">
        </div>
    ...
    <div class="layui-form-item" style="width:800px;">
        ...
        <div class="layui-input-inline" style="width:400px;">
            <input type="text" name="dept_content"  placeholder="请输入备注说明" autocomplete="off" class="layui-input" id="dept_content">
        </div>
...
<script>
    ...
    function save_data_func(){
        ...
        $.ajax({
            ...
            url: "/department/department_add/save",
